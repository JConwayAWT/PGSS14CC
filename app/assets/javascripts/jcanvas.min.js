...
*/
(function(e,ua,va,Sa,da,ba,q,y,h,v){function G(d){for(var c in d)d.hasOwnProperty(c)&&(this[c]=d[c]);return this}function ma(){Z(this,ma.baseDefaults)}function ja(d){return"string"===aa(d)}function L(d){return d&&d.getContext?d.getContext("2d"):h}function wa(d){var c,a,b;for(c in d)d.hasOwnProperty(c)&&(b=d[c],a=aa(b),"string"!==a||""===b||isNaN(b)||(d[c]=ba(b)))}function ka(d){d=Z({},d);d.masks=d.masks.slice(0);return d}function fa(d,c){var a;d.save();a=ka(c.transforms);c.savedTransforms.push(a)}
...
"");return"-"+(ta.call(d).join("").match(/-(moz|webkit|ms)-/)||""===d.OLink&&["","o"])[1]+"-"}();e.fn.triggerLayerEvent=function(d,c){var a,b,g;for(b=0;b<this.length;b+=1)a=e(this[b]),g=F(this[b]),(d=a.getLayer(d))&&Q(a,g,d,c);return this};e.fn.drawLayer=function(d){var c,a,b;for(c=0;c<this.length;c+=1)a=e(this[c]),L(this[c]),(b=a.getLayer(d))&&b.visible&&b._method&&(b._next=h,b._method.call(a,b));return this};e.fn.drawLayers=function(d){var c,a,b=Z({},d),g,f,k,E,P,t,J;b.index||(b.index=0);for(c=
